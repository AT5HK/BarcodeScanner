...
struct AlertContext {
    ...
    static let invalidScannedType = AlertItem(title: "Invalid Scan Type", message: "The value scanned in not valid. This app scans EAN-8 and EAN-13.", dismissButton: .default(Text("OK")))
}
